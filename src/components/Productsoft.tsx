...
function ProductCardsoft({ image, title, link }: { image: string; title: string; link: string }) {
  ...
  if (link.startsWith("#")) {
    ...
    // للانتقال إلى رابط خارجي وفتحه في نافذة جديدة
    window.open(link, "_blank");
  } else {
    // للانتقال إلى صفحة داخلية في الموقع
    navigate(link);
  }
};
      ...
      >
        ...
        >
          ...
          <div className="relative p-6 text-center">
            ...
            <motion.div 
              className="relative mb-4 overflow-hidden rounded-2x1 w-48 h-48 mx-auto shadow-lg group"
